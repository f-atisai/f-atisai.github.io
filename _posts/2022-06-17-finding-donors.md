...
![Dataset Preview](/assets/images/finding-donors/dataset_preview.png){: loading="lazy" decoding="async" }
...
![Skewed Distributions of Continuous Census Data Features](/assets/images/finding-donors/skewed_dist_cont_features.png){: loading="lazy" decoding="async" }
...
![Log-transformed Distributions of Continuous Census Data Features](/assets/images/finding-donors/log_transformed_dist_cont_feats.png){: loading="lazy" decoding="async" }
...
![Normalized Census Data](/assets/images/finding-donors/table_normalized_census_data.png){: loading="lazy" decoding="async" }
...
![One-Hot Encoder Process](/assets/images/finding-donors/table_one_hot_encoder.png){: loading="lazy" decoding="async" }
...
![Performance Metrics for Three Supervised Learning Models](/assets/images/finding-donors/performance_metrics_three_models.png){: loading="lazy" decoding="async" }
...
![Normalized Weights for First Five Most Predictive Features](/assets/images/finding-donors/normalized_weight_first5_most_pred_features.png){: loading="lazy" decoding="async" }
